...
DATABASES = {
    "default": dj_database_url.config(
        default=config(
            "DATABASE_URL",
            default="postgres://shoestore:shoestore@localhost:5432/shoestore",
        ),
        conn_max_age=600,
    )
}
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Single-seller shoe e-commerce platform API",
    "VERSION": "1.0.0",
...
DEFAULT_DELIVERY_FEE = config("DEFAULT_DELIVERY_FEE", default=30, cast=int)

# Payment
PAYMENT_PROVIDER = config("PAYMENT_PROVIDER", default="mock")
PAYMENT_API_KEY = config("PAYMENT_API_KEY", default="")
PAYMENT_SECRET = config("PAYMENT_SECRET", default="")
...
LOGGING = {
    ...
    "loggers": {
        "apps.orders": {"level": "INFO", "propagate": True},
